...
function MatHorizontalStepper_ng_container_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function MatHorizontalStepper_ng_container_1_Template_mat_step_header_click_1_listener() { const step_r112 = ctx.$implicit; return step_r112.select(); })("keydown", function MatHorizontalStepper_ng_container_1_Template_mat_step_header_keydown_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r118); const ctx_r117 = ɵngcc0.ɵɵnextContext(); return ctx_r117._onKeydown($event); });
    ɵngcc0.ɵɵelementEnd();
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("tabIndex", ctx_r110._getFocusIndex() === i_r113 ? 0 : 0 - 1)("id", ctx_r110._getStepLabelId(i_r113))("index", i_r113)("state", ctx_r110._getIndicatorType(i_r113, step_r112.state))("label", step_r112.stepLabel || step_r112.label)("selected", ctx_r110.selectedIndex === i_r113)("active", step_r112.completed || ctx_r110.selectedIndex === i_r113 || !ctx_r110.linear)("optional", step_r112.optional)("errorMessage", step_r112.errorMessage)("iconOverrides", ctx_r110._iconOverrides)("disableRipple", ctx_r110.disableRipple);
    ɵngcc0.ɵɵattribute("aria-posinset", i_r113 + 1)("aria-setsize", ctx_r110.steps.length)("aria-controls", ctx_r110._getStepContentId(i_r113))("aria-selected", ctx_r110.selectedIndex == i_r113)("aria-label", step_r112.ariaLabel || null)("aria-labelledby", !step_r112.ariaLabel && step_r112.ariaLabelledby ? step_r112.ariaLabelledby : null);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !isLast_r114);
} }
function MatHorizontalStepper_div_3_Template(rf, ctx) { if (rf & 1) {
    const _r122 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "div", 7);
    ɵngcc0.ɵɵlistener("@stepTransition.done", function MatHorizontalStepper_div_3_Template_div_animation_stepTransition_done_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r122); const ctx_r121 = ɵngcc0.ɵɵnextContext(); return ctx_r121._animationDone.next($event); });
    ɵngcc0.ɵɵelementContainer(1, 8);
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const step_r119 = ctx.$implicit;
    const i_r120 = ctx.index;
    const ctx_r111 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("@stepTransition", ctx_r111._getAnimationDirection(i_r120))("id", ctx_r111._getStepContentId(i_r120));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r111.selectedIndex === i_r120 ? 0 : null)("aria-labelledby", ctx_r111._getStepLabelId(i_r120))("aria-expanded", ctx_r111.selectedIndex === i_r120);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", step_r119.content);
} }
function MatVerticalStepper_div_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function MatVerticalStepper_div_0_Template_mat_step_header_click_1_listener() { const step_r124 = ctx.$implicit; return step_r124.select(); })("keydown", function MatVerticalStepper_div_0_Template_mat_step_header_keydown_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r129); const ctx_r128 = ɵngcc0.ɵɵnextContext(); return ctx_r128._onKeydown($event); });
    ɵngcc0.ɵɵelementEnd();
    ɵngcc0.ɵɵelementStart(2, "div", 3);
    ɵngcc0.ɵɵelementStart(3, "div", 4);
    ɵngcc0.ɵɵlistener("@stepTransition.done", function MatVerticalStepper_div_0_Template_div_animation_stepTransition_done_3_listener($event) { ɵngcc0.ɵɵrestoreView(_r129); const ctx_r130 = ɵngcc0.ɵɵnextContext(); return ctx_r130._animationDone.next($event); });
    ...
    const step_r124 = ctx.$implicit;
    const i_r125 = ctx.index;
    const isLast_r126 = ctx.last;
    const ctx_r123 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("tabIndex", ctx_r123._getFocusIndex() == i_r125 ? 0 : 0 - 1)("id", ctx_r123._getStepLabelId(i_r125))("index", i_r125)("state", ctx_r123._getIndicatorType(i_r125, step_r124.state))("label", step_r124.stepLabel || step_r124.label)("selected", ctx_r123.selectedIndex === i_r125)("active", step_r124.completed || ctx_r123.selectedIndex === i_r125 || !ctx_r123.linear)("optional", step_r124.optional)("errorMessage", step_r124.errorMessage)("iconOverrides", ctx_r123._iconOverrides)("disableRipple", ctx_r123.disableRipple);
    ɵngcc0.ɵɵattribute("aria-posinset", i_r125 + 1)("aria-setsize", ctx_r123.steps.length)("aria-controls", ctx_r123._getStepContentId(i_r125))("aria-selected", ctx_r123.selectedIndex === i_r125)("aria-label", step_r124.ariaLabel || null)("aria-labelledby", !step_r124.ariaLabel && step_r124.ariaLabelledby ? step_r124.ariaLabelledby : null);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵclassProp("mat-stepper-vertical-line", !isLast_r126);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("@stepTransition", ctx_r123._getAnimationDirection(i_r125))("id", ctx_r123._getStepContentId(i_r125));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r123.selectedIndex === i_r125 ? 0 : null)("aria-labelledby", ctx_r123._getStepLabelId(i_r125))("aria-expanded", ctx_r123.selectedIndex === i_r125);
    ɵngcc0.ɵɵadvance(2);
